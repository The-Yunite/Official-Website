              ...
              >
                ...
                <div className="flex-1 p-6 text-left flex flex-col justify-between">
                  ...
                  <div className="mt-6 flex gap-3">
                    <Link href={s.action?.["Learn More Link"]!} className="inline-flex items-center gap-2 bg-linear-to-r from-[#ff6b35] to-[#b9ff66] text-black rounded-full shadow-md py-2 px-4 font-semibold hover:shadow-lg transition">
                      Learn More <ArrowUpRight size={18} />
                    </Link>
                    <Link href={s.action?.["Get Quote Link"]!} className="inline-flex items-center gap-2 border border-black rounded-full py-2 px-4 font-semibold text-black hover:bg-black/10 transition">
                      Get Quote
                    </Link>
                  </div>
                </div>
