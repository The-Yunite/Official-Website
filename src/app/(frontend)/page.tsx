  ...
  return (
    <main className='mt-24 px-8 md:px-10 flex flex-col items-center min-h-screen overflow-hidden'>
      ...
      <section className='my-10'>
        ...
        <div className='flex flex-wrap justify-around gap-6 my-10 text-gray-800'>
          {events.map((event) => (
            <div key={event.id} className="duration-500 w-xs bg-white/70 relative group border border-black/10 rounded-3xl backdrop-blur-sm overflow-hidden shadow-lg hover:shadow-[#ff6b35]/40 transition transform hover:-translate-y-3 hover:scale-105">
              ...
              <div className='p-5'>
                <b className='text-xl text-black'>{event.title}</b>
                <p className='flex items-center gap-1 text-gray-800'><Calendar size={18} className='inline-block' />{event.date}</p>
                <p className='flex items-center gap-1 text-gray-800'><MapPin size={18} className='inline-block' />{event.location}</p>
                <p className='flex items-center gap-1 my-1 text-gray-700'>{event.type}</p>
                <button className='rounded-full hover:bg-[#ff6b35]/15 hover:scale-105 transition-transform duration-500 w-full border border-[#ff6b35] py-2 my-3 font-semibold text-black'>
      ...
      <section className='my-10'>
        ...
        <div className='my-10 flex flex-wrap justify-center gap-10 md:gap-16 text-center text-gray-800'>
          <SpotlightCard className="custom-spotlight-card scaleOnHover mx-auto text-center w-xs border border-black/10 bg-white/60 shadow-lg hover:shadow-[#ff6b35]/40" spotlightColor="rgba(255, 107, 53, 0.15)">
            ...
            <p className='text-xl font-semibold text-black'>Web Apps</p>
          ...
          <SpotlightCard className="custom-spotlight-card scaleOnHover w-xs border border-black/10 bg-white/60 shadow-lg hover:shadow-[#ff6b35]/40" spotlightColor="rgba(255, 107, 53, 0.15)">
            ...
            <p className='text-xl font-semibold text-black'>Automations</p>
      ...
      <section className='w-full my-10 mx-auto text-center'>
        ...
        <div className='mt-5 text-gray-800 text-balance flex flex-col gap-4 text-xl'>
        ...
        <div className='mt-10 flex flex-wrap justify-center gap-10 md:gap-16 text-center text-2xl text-gray-800'>
          <SpotlightCard className="custom-spotlight-card scaleOnHover border border-black/10 bg-white/60 shadow-lg hover:shadow-[#ff6b35]/40" spotlightColor="rgba(255, 107, 53, 0.15)">
      ...
      <section className='flex items-center flex-col my-10'>
        ...
        <div className='mt-5 text-center'>
          ...
          <p className='text-xl font-semibold text-[#f07c4a]'>
